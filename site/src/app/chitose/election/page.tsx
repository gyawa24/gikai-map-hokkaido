...
export const metadata: Metadata = {
  title: "選挙結果 | 北海道議会情報マップ - 千歳市",
  description: "千歳市議会議員選挙の結果（得票数・当落）を掲載しています。",
  openGraph: {
    title: "千歳市議会 選挙結果 | 北海道議会情報マップ",
    description: "千歳市議会議員選挙の結果（得票数・当落）を掲載しています。",
  },
};
...
function getElectionData(): ElectionData | null {
  const fp = path.join(process.cwd(), "data", "chitose", "election.json");
  try {
...
export default function ChitoseElectionPage() {
