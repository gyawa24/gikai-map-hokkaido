            ...
            <div className="bg-white rounded-lg border border-[#CBD5E0] shadow-sm px-5 py-4 mb-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {topThemes.map((theme) => (
                  <Link
                    key={theme}
                    href={`/ai-search?q=${encodeURIComponent(`苫小牧市議会での「${theme}」に関する議論を教えてください`)}`}
                ...
                <div className="px-5 py-4">
                    ...
                    {s.topics.map((t) => (
                      <li key={t} className="flex items-start gap-2 text-sm group">
                        ...
                        <div className="flex-1 flex items-start justify-between gap-2">
                          {s.council_id > 0 ? (
                            <Link
                              href={`/tomakomai/minutes/${s.council_id}?q=${encodeURIComponent(t)}`}
                  ...
                  {s.council_id > 0 && (
                    <div className="mt-3 pt-3 border-t border-[#E2E8F0]">
                      <Link
                        href={`/tomakomai/minutes/${s.council_id}`}
