...
function getSession(id: string): MinutesSession | null {
  const fp = path.join(process.cwd(), "data", "nakagawa", "minutes", `${id}.json`);
  try {
...
function getEnriched(id: string): MinutesEnriched | null {
  const fp = path.join(process.cwd(), "data", "nakagawa", "minutes", "enriched", `${id}.json`);
  try {
...
export async function generateStaticParams() {
  const fp = path.join(process.cwd(), "data", "nakagawa", "minutes", "index.json");
  try {
...
export default async function NakagawaMinutesDetailPage({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
