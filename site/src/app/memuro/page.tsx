...
export const metadata: Metadata = {
  title: "芽室町議会",
  description: "芽室町議会の議員一覧・議事録を掲載しています。",
  openGraph: {
    title: "芽室町議会 | 北海道議会情報マップ",
    description: "芽室町議会の議員一覧・議事録を掲載しています。",
  },
};
...
function getMembers(): Member[] {
  try {
    const fp = path.join(process.cwd(), "data", "memuro", "members.json");
...
export default function MemuroMembersPage() {
  ...
  const { count: minutesCount, latestYear } = getMinutesSummary("memuro");
      ...
      <>
        ...
        <div className="max-w-2xl mx-auto">
          <section className="mb-6">
            ...
            <p className="text-base text-[#4A5568] leading-relaxed">芽室町議会の議員情報です。</p>
          </section>
  ...
  return (
    <>
      <CitySummaryCards
        ...
        latestYear={latestYear}
      />
      <MemberList members={members} factions={factions} activity={{}} memberHrefBase="/memuro/members" />
    </>
  );
}
